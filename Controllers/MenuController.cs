...
namespace PICI.Controllers
{
    ...
    public class MenuController : ControllerBase
    {
        ...
        // POST api/values
        [HttpPost("AddDetails")]
        public IActionResult Post(int Menuid=0, string Menu=null, string Description=null, string PageUrl=null, string Icon=null, int sortorder=0)
        {
            var msg = new Message();
            _repository.NewMenu(Menuid,Menu,  Description,PageUrl,  Icon,sortorder);
        ...
        // PUT api/values/5
        [HttpPut("Update/{id}")]
        public IActionResult Update(int Menuid = 0, string Menu = null, string Description = null, string PageUrl = null, string Icon = null, int sortorder = 0)
        {
            var msg = new Message();
