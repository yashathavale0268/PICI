...
namespace PICI.Controllers
{
    ...
    public class SigninController : ControllerBase
    {
        ...
        private readonly SigninRepository _repository;
        //  private readonly AmsRepository _common;
        //  private readonly string key;
        public SigninController(SigninRepository repository, /*AmsRepository common,*/ ILogger<SigninController> logger)
        {
        ...
        public async Task<IActionResult> SetRole(int Role = 0,int id = 0)
        {
         ...
         if (success is true)
            ...
            {
                msg.IsSuccess = false;
                msg.ReturnMessage = " Update unsuccessful";
            }
